...
def parse_arguments():
    ...
    parser.add_argument('--method', default='simclr', help='Method to run: ssl or fine_tuning')
    # parse beta tau plas and temperature
...
def ssl_pre_training(args, modality, cfg, dataset_cfg, experiment_id, loggers_list, loggers_dict):
    ...
    model = SimCLRUnimodal(args, modality, encoder, encoder.out_size,args.framework, **cfg['modalities'][modality]['model']['ssl']['kwargs'])
...
def main():
    ...
    print("run_seeds", args.run_seeds)
    print("=============================================")
